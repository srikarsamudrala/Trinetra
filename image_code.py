...
while True:
	...
	for (x,y,w,h) in faces:
		...
		if(len(arr)>0):
			...
			if(x-xcoord>0 and y-ycoord>0 and wx>0 and wy<786 ):               
				wx=wx-35
				wy=wy+25
				pyautogui.moveTo(wx,wy,duration=1)
			if(x-xcoord<0 and y-ycoord>1 and wx<1368 and wy<786):
				wx=wx+35
				wy=wy+25
				pyautogui.moveTo(wx,wy,duration=1)
	...
	frame=cv2.resize(frame,(1368,786))
